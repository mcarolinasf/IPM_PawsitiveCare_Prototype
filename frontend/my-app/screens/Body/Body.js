    ...
    <SafeAreaView style={globalStyles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={{ paddingHorizontal: 10 }}>
          <TextInputDefault
            label={"Name"}
            setFunction={(value) => setEditedPet({ ...editedPet, name: value })}
          ...
          <View style={BodyStyles.row}>
            <View style={{ flex: 1, paddingRight: 10 }}>
              <TextInputDefault
                label={"Age"}
                setFunction={(value) =>
                  setEditedPet({ ...editedPet, age: value })
                }
                value={editedPet.age}
              ...
              <TextInputDefault
                label={"Breed"}
                setFunction={(value) =>
                  setEditedPet({ ...editedPet, breed: value })
                }
              ...
              <TextInputDefault
                label={"Type of coat"}
                setFunction={(value) =>
                  setEditedPet({ ...editedPet, typeOfCoat: value })
                }
                value={editedPet.typeOfCoat}
                placeholder={pet.typeOfCoat}
              />
            </View>
            ...
            <View style={{ flex: 1 }}>
              ...
              <TextInputDefault
                label={"Color"}
                setFunction={(value) =>
                  setEditedPet({ ...editedPet, color: value })
                }
              ...
              <TextInputDefault
                label={"Tail"}
                setFunction={(value) =>
                  setEditedPet({ ...editedPet, tail: value })
                }
                value={editedPet.tail}
                placeholder={pet.tail}
              />
            </View>
          </View>
          <TextInputDefault
            ...
            setFunction={(value) =>
              setEditedPet({ ...editedPet, distinguishMarks: value })
            }
            value={editedPet.distinguishMarks}
            placeholder={pet.distinguishMarks}
          />
          <View style={BodyStyles.row}>
            <View style={{ flex: 1, paddingRight: 10 }}>
              <TextInputDefault
                label={"Weight"}
                setFunction={(value) =>
                  setEditedPet({ ...editedPet, weight: value })
                }
            ...
            <View style={{ flex: 1 }}>
              <TextInputDefault
                label={"Height"}
                setFunction={(value) =>
                  setEditedPet({ ...editedPet, height: value })
                }
        ...
        <View style={{ ...PetStyles.container, ...globalStyles.shadow }}>
          <Image style={PetStyles.chart} source={chart} />
        </View>
      </ScrollView>
    </SafeAreaView>
  );
