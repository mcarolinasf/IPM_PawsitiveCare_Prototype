      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
          <MenuCard
            ...
            navigateTo={navigationPaths.vetAppointments}
          />
          <MenuCard
            iconName={"dog"}
            title={"Body"}
            navigation={navigation}
            navigateTo={navigationPaths.body}
            pet={pet}
          />
          <MenuCard
            iconName={"pills"}
            title={"Medication"}
            navigation={navigation}
            navigateTo={navigationPaths.medication}
            pet={pet}
          />
          <MenuCard
            iconName={"bone"}
            title={"Feeding"}
            navigation={navigation}
            navigateTo={navigationPaths.feeding}
            pet={pet}
          />
        </ScrollView>
        ...
        <View>
          {tasks &&
            tasks
              .filter((task) => task.petId == pet.idP)
              .map((task) => (
                <TaskItem
                  key={task.key}
                  task={task}
