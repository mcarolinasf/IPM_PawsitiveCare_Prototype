    ...
    <SafeAreaView style={globalStyles.container}>
      <ScrollView>
          ...
          <View style={AddPetStyles.container} {...globalStyles.shadow}>
            ...
            {!image && (
              <View style={AddPetStyles.icon}>
                ...
                <Text style={{ color: colors.secondary }}>Mandatory</Text>
              </View>
            )}
          </View>
        </TouchableOpacity>
        <View style={{ paddingHorizontal: 10 }}>
          <TextInputDefault
            label={"Name   *"}
            setFunction={(value) => setNewPet({ ...newPet, name: value })}
            value={newPet.name}
          />
          ...
          <View style={AddPetStyles.row}>
            <View style={{ flex: 1, paddingRight: 10 }}>
              <TextInputDefault
                label={"Age"}
                setFunction={(value) => setNewPet({ ...newPet, age: value })}
                value={newPet.age}
              />
              <TextInputDefault
                label={"Breed"}
                setFunction={(value) => setNewPet({ ...newPet, breed: value })}
                value={newPet.breed}
              />
              <TextInputDefault
                label={"Type of coat"}
                setFunction={(value) =>
                  setNewPet({ ...newPet, typeOfCoat: value })
                }
                value={newPet.typeOfCoat}
              />
            </View>
            ...
            <View style={{ flex: 1 }}>
              <TextInputDefault
                label={"Gender"}
                setFunction={(value) => setNewPet({ ...newPet, gender: value })}
                value={newPet.gender}
              />
              <TextInputDefault
                label={"Color"}
                setFunction={(value) => setNewPet({ ...newPet, color: value })}
                value={newPet.color}
              />
              <TextInputDefault
                label={"Tail"}
                setFunction={(value) => setNewPet({ ...newPet, tail: value })}
                value={newPet.tail}
              />
            </View>
          </View>
          <TextInputDefault
            label={"Distinguish Marks"}
            setFunction={(value) =>
              setNewPet({ ...newPet, distinguishMarks: value })
            }
            value={newPet.distinguishMarks}
          />
          <View style={AddPetStyles.row}>
            <View style={{ flex: 1, paddingRight: 10 }}>
              <TextInputDefault
                label={"Weight"}
                setFunction={(value) => setNewPet({ ...newPet, weight: value })}
                value={newPet.weight}
              />
            </View>
            <View style={{ flex: 1 }}>
              <TextInputDefault
                label={"Height"}
                setFunction={(value) => setNewPet({ ...newPet, height: value })}
                value={newPet.height}
              />
            </View>
          </View>
