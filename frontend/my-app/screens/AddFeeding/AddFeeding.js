      ...
      <ScrollView>
        ...
        <View style={{ paddingHorizontal: 10 }}>
          ...
          <TextInputDefault
            label={"Food"}
            setFunction={(value) =>
              setNewFeeding({ ...newFeeding, food: value })
            }
          ...
          <TextInputDefault
            label={"Starting Date"}
            setFunction={(value) =>
              setNewFeeding({ ...newFeeding, startD: value })
            }
            value={newFeeding.food}
          />
          <TextInputDefault
            label={"End Date"}
            setFunction={(value) =>
              setNewFeeding({ ...newFeeding, endD: value })
            }
            value={newFeeding.food}
          />
          <TextInputDefault
            label={"Periodicity"}
            setFunction={(value) =>
              setNewFeeding({ ...newFeeding, period: value })
            }
            value={newFeeding.food}
          />
          <TextInputDefault
            label={"Dosage"}
            setFunction={(value) =>
              setNewFeeding({ ...newFeeding, dosage: value })
            }
            value={newFeeding.food}
          />
        </View>
